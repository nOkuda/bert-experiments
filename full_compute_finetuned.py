...
def _main():
    ...
    for name, scorer in {
            ...
            scorer_builder(_score_by_rescaled_max_word_factor_norm,
                           'scoreds_finetuned_c.pickle'),
            'Rescaled Max Diff':
            scorer_builder(_score_by_rescaled_max_diff,
                           'scoreds_finetuned_d.pickle'),
            'Threshold and Rescaling':
            scorer_builder(_score_by_threshold_and_rescaling,
                           'scoreds_finetuned_e.pickle'),
            'Threshold and Rescaled Max Word':
            scorer_builder(_score_by_threshold_and_rescaled_max_word,
                           'scoreds_finetuned_f.pickle'),
            'With Stopwords':
            scorer_builder(_score_with_stopwords,
                           'scoreds_finetuned_g.pickle'),
            'With Stopwords and Threshold':
            scorer_builder(_score_with_stopwords_and_threshold,
                           'scoreds_finetuned_h.pickle'),
            'With Stopwords and Lemmata':
            scorer_builder(_score_with_stopwords_and_lemmata,
                           'scoreds_finetuned_i.pickle'),
            'Mean Pool Cos Sim':
            scorer_builder(_score_by_mean_pool_cos_sim,
                           'scoreds_finetuned_j.pickle')
    }.items():
...
def _compute_similarities(aeneid_data, lucan_data):
    outpath = Path('mult_finetuned.npy')
    if outpath.exists():
